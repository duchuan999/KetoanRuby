        ...
        newLang: function () {
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "Vui lòng nhập thông tin, không được bỏ trống.",
                ...
                "minSize": {
                    "regex": "none",
                    "alertText": "Chiều dài chưa hợp lý, tối thiểu là ",
                    "alertText2": "."
                },
                "maxSize": {
                    "regex": "none",
                ...
                "equals": {
                    "regex": "none",
                    "alertText": "Mật khẩu không trùng khớp vui lòng kiểm tra lại."
                },
                "creditCard": {
                    "regex": "none",
                ...
                "email": {
                    ...
                    "alertText": "Địa chỉ email không hợp lệ, ví dụ: tenban@tencongty.com!"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                    "alertText": "Vui lòng nhập một số nguyên."
                },
                "number": {
                ...
                "date": {
                    ...
                    "alertText": "Ngày sinh không hợp lệ, phải theo định dạng dd/mm/yyyy."
                },
                "ipv4": {
